...
- **Ajuster automatiquement la longueur de toutes les descriptions pour que le CV tienne sur exactement une page.** Si le contenu dépasse une page, réduire dans cet ordre : nombre de missions par expérience → longueur des missions → taille de l'accroche → rubriques les moins pertinentes.
